$(function(){
    ...
    window.myInit = function() {
        ...
        this.log("this.arguments", this.arguments)
    ...
    window.ConductorModel = FileModel.extend({
        ...
        initialize: function(){
            ...
            FileModel.prototype.initialize.apply(this, this.attributes.extended);
    ...
    window.TimeSlider = SliderView.extend({
        ...
        formatTime: function(nanosecnods) {
        ...
        onValueChange: function() {
            this.$timeInput.val(this.formatTime(this.model.get("value")));
        },
        render: function(){
            ...
            this.$timeInput2 = $("<input/>");
            this.$timeInput2.prop("class", this.$el.prop("class"));
            this.$el.parent(".ui-slider").prepend(this.$timeInput);
            // this.$el.parent(".ui-slider").append(this.$timeInput2);
            // this.$el.parent(".ui-slider").find(".ui-slider-track").css("width", "80%");
            return this;
        } 
    });
    ...
    window.PlayingFileView = FileView.extend({
        ...
        displayAdd: false,
        initialize: function(){
            FileView.prototype.initialize.apply(this, this.options.conductor.playing);
