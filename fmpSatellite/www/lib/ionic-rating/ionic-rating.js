...
(function() {
  angular.module('ionic.rating', []).constant('ratingConfig', {
    ...
    return {
      ...
      template: '<ul class="rating" ng-mouseleave="reset()" ng-keydown="onKeydown($event)">' + '<li ng-repeat="r in range track by $index" ng-click="rate($index)"><i ng-class="$index <= value && (r.stateOn || \'ion-ios-star\') || (r.stateOff || \'ion-ios-star-outline\')">&nbsp;</i></li>' + '</ul>',
      replace: true,
